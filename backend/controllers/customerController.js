...
exports.updateCustomerStatus = async (req, res) => {
  try {
    ...
    if (customer) {
      ...
      // Legacy/partial records may predate required fields. Never let an
      // approve/hold/reject action fail because the customer is missing a
      // required field such as `address`.
